...
$classifier->learn('Php is the best', Type::POSITIVE);
$classifier->learn('PhpStorm is great', Type::POSITIVE);
$classifier->learn('People complains a lot', Type::NEGATIVE);
$classifier->learn('No php is bad', Type::NEGATIVE);
var_dump($classifier->guess('Php is great')); // string(8) "positive"
